...
export class PostRefactoring1749946208592 implements MigrationInterface {
    name = 'PostRefactoring1749946208592'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "email" ("email" character varying NOT NULL, CONSTRAINT "PK_fee9013b697946e8129caba8983" PRIMARY KEY ("email"))`);
